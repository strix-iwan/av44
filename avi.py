...
os.chdir(os.path.dirname(os.path.abspath(__file__))) # Теперь ваш код будет работать с файлами в той же директории, что и исполняемый файл
    ...
    def __pretty_log(data):
        ...
        if data.get("description"):
            ...
            if len(description) > 50:
                description = description[:150] + '...'  # Добавляем многоточие
            log_message += f'Описание: {description}\n'
